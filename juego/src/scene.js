...
Crafty.scene('Game2', function() {
	...
	//place a border at 21x2:14 to separate the game area
	 ...
	 for(var i=2;i<20;i++){
	 	...
	 	if(i>=2 && i<=6){
	 		Crafty.e('Cable_hor').at(i,3);
	 		Crafty.e('Cable_hor').at(i,5);
	 		Crafty.e('Cable_hor').at(i,9);		
	 		Crafty.e('Cable_hor').at(i,11);
	 		this.occupied[i][3] = true;
	 		this.occupied[i][5] = true;
	 		this.occupied[i][9] = true;
	 		this.occupied[i][11] = true;
	 	}
	 	if(i>=8 && i<=9){
	 		Crafty.e('Cable_hor').at(i,4);
	 		Crafty.e('Cable_hor').at(i,10);
	 		this.occupied[i][4] = true;
	 		this.occupied[i][10] = true;
	 	}
		if(i>=11 && i<=19){
	 		Crafty.e('Cable_hor').at(i,4);
	 ...
	 Crafty.e('Cable_ver').at(10,5);
	 this.occupied[10][5] = true;
	 Crafty.e('Cable_ver').at(10,9);
	 this.occupied[10][9] = true;
	 Crafty.e('Cable_cod1').at(10,8);
	 this.occupied[10][8] = true
	 Crafty.e('Cable_cod4').at(10,6);
	 this.occupied[10][6] = true;
	 Crafty.e('Cable_tri2').at(10,4);
	 this.occupied[10][4] = true;
	 Crafty.e('Cable_tri1').at(10,10);
	 ...
	 Crafty.e('In0').at(1, 5)
	 Crafty.e('In1').at(1, 9)
	 Crafty.e('In0').at(1, 11)
	 Crafty.e('Out1').at(20, 4)
	 Crafty.e('Out0').at(20, 7)
	 Crafty.e('Out0').at(20, 10)
	 ...
	 compuertas.push(Crafty.e('Or').at(23,8).compuerta(23,8,this.occupied,selector_grande));
	 compuertas.push(Crafty.e('Or').at(25,8).compuerta(25,8,this.occupied,selector_grande));

	 //condiciones para ganar. Cuidado con tener varias soluciones para el problema.
	 var condiciones = [];
	 condiciones[0]=[];
	 condiciones[0].push(['not',17,7]);
	 condiciones[0].push(['and',7,9]);
	 condiciones[0].push(['or',7,3]);
	 condiciones[0].push(['or',13,6]);
